                                ...
                                children: [
                                  RichText(
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          text: widget.post.userDisplayName ?? 'Anonymous User',
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: AnimatedContainer(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                AnimatedScale(
                                                  scale: hasLiked ? (_iconAnimation?.value ?? 1.0) : 1.0,
                                                  duration: const Duration(milliseconds: 200),
                                                  child: Icon(
                                                    hasLiked ? Icons.thumb_up : Icons.thumb_up_outlined,
                                                    color: hasLiked ? Colors.white : const Color(0xFF2E4F99),
                                                    size: 18,
                                                  ),
                                                ),
                  ...
                  if (loadingComments)
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SubThreadCard(comment: comment);
                      },
                    ),
                ],
              ),
              ...
              child: Row(
                children: [
                  ...
                  FutureBuilder<UserModel?>(
                    future: _authService.getUserProfile(_authService.currentUser?.id ?? ''),
...
class SubThreadCard extends StatefulWidget {
  ...
  const SubThreadCard({super.key, required this.comment});
...
class _SubThreadCardState extends State<SubThreadCard>
  ...
  void initState() {
    super.initState();
    likeCount = 0; // Comments don't have like count initially, would need backend support
