...
async function generatePasswordHashes() {
  ...
  console.log(
    `INSERT INTO admin_users (email, password_hash, name, role) VALUES ('admin@example.com', '${passwords["admin123"]}', 'Admin User', 'admin');`
  );
  console.log(
    `INSERT INTO admin_users (email, password_hash, name, role) VALUES ('superadmin@example.com', '${passwords["super123"]}', 'Super Admin', 'superadmin');`
  );
}
